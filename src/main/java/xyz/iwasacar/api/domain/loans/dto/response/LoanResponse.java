...
public class LoanResponse {
	...
	public static LoanResponse of(final Loan loan, final Integer customerLoan, final Integer customerPeriod) {
		return new LoanResponse(loan.getName(), loan.getLimit(), loan.getInterestRate(), loan.getRedemption(),
			loan.getPeriod(), customerLoan / customerPeriod, customerLoan, customerPeriod);
	}
